...
class D1HRough(LeggedRobot):
    ...
    # --------------------- sammy reward functions --------------------- #
    def _reward_base_ground_distance(self):
        base_height = self._get_base_heights()
        reward = torch.where(base_height > 0.2, 1.0, 0.0)
        return reward
